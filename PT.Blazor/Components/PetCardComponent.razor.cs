...
public partial class PetCardComponent
{
    ...
    private readonly Dictionary<SocialMediaType, (string Icon, string UrlTemplate)> socialMap =
        new()
        {
            ...
            { SocialMediaType.Viber,     (viberIcon,     "viber://add?number={0}")}
        };
